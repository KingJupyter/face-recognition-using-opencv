...
How to use
```
git clone https://github.com/KingJupyter/face-recognition-using-opencv
```
```
...
![Result](https://github.com/KingJupyter/face-recognition-using-opencv/blob/master/images/output1.png)
